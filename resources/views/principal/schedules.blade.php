...
<head>
    ...
    <title>Schedules - Principal Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('principal.schedules') }}" class="nav-link active">
        ...
        <div class="content-wrapper" id="contentWrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Class Schedules</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">All Class Schedules ({{ $schedules->total() }})</h3>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($schedule->teacher)
                                                                ...
                                                                <br><small class="text-muted">{{ $schedule->teacher->staff_code }}</small>
                                                            @else
                                                        ...
                                                        <td>
                                                            @if($schedule->room)
                                                                {{ $schedule->room->name }}
                                                                <br><small class="text-muted">{{ $schedule->room->room_code }}</small>
                                                            @else
                                                                <span class="text-muted">{{ $schedule->room_code }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-info btn-sm" onclick="viewSchedule({{ $schedule->id }})">
                                                                <i class="fa fa-eye"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
    ...
    <script>
        ...
        function viewSchedule(scheduleId) {
            ...
            alert('View schedule details for ID: ' + scheduleId);
        }
